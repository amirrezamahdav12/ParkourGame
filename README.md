سلام! بر اساس درخواست شما، محتوای `README.md` را از متن اصلی جدا کرده‌ام و با رعایت دقیق‌ترین ساختار مارک‌دان، آن را بازنویسی کرده‌ام. همچنین نکات زیر را اصلاح کردم:

- حذف مقدمه‌های غیرمرتبط با فایل README.
- یکسان‌سازی فاصله‌ها و تورفتگی‌ها.
- اصلاح ترتیب بخش‌ها و اطمینان از درستی جداول، کدبلاک‌ها و لینک‌ها.
- افزودن چند نشان (badge) برای نمایش وضعیت و مجوز.

در زیر، فایل نهایی `README.md` را مشاهده می‌کنید که آماده‌ی کپی و استفاده در مخزن شماست:
